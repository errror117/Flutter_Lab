...
title: 'Flutter P3', theme: ThemeData(
...
Text('Row',style: TextStyle(fontSize: 25),), Center(
child: Row(
mainAxisAlignment: MainAxisAlignment.spaceEvenly, children: <Widget>[
Container(
margin: EdgeInsets.all(12.0), padding: EdgeInsets.all(8.0), decoration:BoxDecoration(
...
Container(
margin: EdgeInsets.all(15.0), padding: EdgeInsets.all(8.0), decoration:BoxDecoration(
...
Column(
children: <Widget>[
Text('Column',style: TextStyle(fontSize: 25),), Container(
margin: EdgeInsets.all(20.0), padding: EdgeInsets.all(12.0), decoration: BoxDecoration(
